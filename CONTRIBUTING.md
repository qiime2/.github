...
You can build your QIIME 2 tools in your own way - your new tool doesn't need to live in our GitHub organization, or be part of one of the QIIME 2 distributions, and in fact it's probably better for it to start independently.
